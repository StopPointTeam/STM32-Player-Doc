...
void GBK_LibFont_Test(void)
{
	...
	GBK_Show_Str(24,0,240,32,"十种字库测试",32,D_Color,GRAY0,0);	
	...
	GBK_Show_Str(16,120,240,12,"汉字12x12-GBK字库：",12,D_Color,B_Color,0);	//显示内码低字节
				
				
	GBK_Show_Str(16,136,240,16,"汉字16x16字库：",16,D_Color,B_Color,0);	//显示内码低字节
				

	GBK_Show_Str(16,156,240,24,"24x24字库：",24,D_Color,B_Color,0);	//显示内码低字节
